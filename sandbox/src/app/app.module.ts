...
import {
  ...
  HelloComponent,
} from './component-outlet.component';
import {
  ComponentOutlet2Component,
  GreetComponent,
} from './component-outlet2.component';
import {
  ComponentOutlet3Component,
  ContentComponent,
} from './component-outlet3.component';
import { TemplateOutletComponentDynamic } from './template-outlet-dynamic.component';
import { AccountCompositionComponent } from './account.composition.component';
...
@NgModule({
  ...
  imports: [BrowserModule, FormsModule, AccountCompositionComponent],
  providers: [],
