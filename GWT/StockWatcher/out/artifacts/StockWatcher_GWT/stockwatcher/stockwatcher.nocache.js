    ...
    function installCode(code_0){
      ...
      if (stockwatcher.__errFn) {
        script.onerror = function(){
          stockwatcher.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
